  ...
  return (
    <div className="container mx-auto p-4 max-w-6xl">
      ...
      <div className="flex flex-col gap-8 lg:flex-row">
            ...
            >
              ...
              >
                ...
                <div className="min-w-0">
                  <h2 className="tgext-lg font-semibold truncate sm:text-xl">
                    {item.product.name}
                  </h2>
        ...
        <div className="w-full h-fit bg-white lg:w-80 lg:sticky lg:top-4 p-6 border rounded order-first lg:order-last fixed bottom-0 left-0 lg:left-auto">
