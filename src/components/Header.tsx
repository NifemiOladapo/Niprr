...
const Header = () => {
  ...
  return (
    <header className="flex flex-wrap justify-between items-center p-4 py-2">
      <div className="flex justify-between w-full flex-wrap items-center">
        ...
        <div className="flex items-center flex-wrap space-x-4 mt-4 flex-1 sm:mt-0 sm:flex-none">
          <Link
            href="/basket"
            className="flex-1 relatve flex justify-center sm:justify-start sm:flex-none items-center space-x-2 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"
          >
